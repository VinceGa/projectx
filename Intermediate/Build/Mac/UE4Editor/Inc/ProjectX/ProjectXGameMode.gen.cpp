...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AProjectXGameMode_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AProjectXGameMode_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AProjectXGameMode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AProjectXGameMode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AProjectXGameMode, 1100182544);
	template<> PROJECTX_API UClass* StaticClass<AProjectXGameMode>()
	{
		return AProjectXGameMode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AProjectXGameMode(Z_Construct_UClass_AProjectXGameMode, &AProjectXGameMode::StaticClass, TEXT("/Script/ProjectX"), TEXT("AProjectXGameMode"), false, nullptr, nullptr, nullptr);
